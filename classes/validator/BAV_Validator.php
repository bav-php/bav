...
BAV_Autoloader::add('exception/BAV_ValidatorException_NotExists.php');
BAV_Autoloader::add('exception/BAV_ValidatorException_ESER.php');
BAV_Autoloader::add('exception/BAV_ValidatorException_OutOfBounds.php');
