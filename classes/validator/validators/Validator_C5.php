 ...
 */
class Validator_C5 extends Validator
{
    ...
    public function __construct(Bank $bank)
    {
        ...
        $this->mode1 = new Validator_75($bank);
        $this->mode2 = new Validator_29($bank);
        $this->mode3 = new Validator_00($bank);
        $this->mode4 = new Validator_09($bank);
    }
