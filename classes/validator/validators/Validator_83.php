 ...
 */
class Validator_83 extends Validator_Chain
{
    ...
    public function __construct(Bank $bank)
    {
        ...
        $this->defaultValidators[] = new Validator_32($bank);
        ...
        $this->modeC = new Validator_33($bank);
        ...
        $this->exceptionValidators[] = new Validator_83x($bank);
    }
