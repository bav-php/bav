...
BAV_Autoloader::add('BAV_Validator_18.php');
BAV_Autoloader::add('BAV_Validator_10.php');
 ...
 * Implements D9
 *
 * Copyright (C) 2012  Markus Malkusch <bav@malkusch.de>
 *
 ...
 */
class BAV_Validator_D9 extends BAV_Validator_Chain {
    ...
    public function __construct(BAV_Bank $bank) {
        ...
        $this->validators[] = new BAV_Validator_18($bank);
    }
