 ...
 */
class Validator_B8 extends Validator_Chain
{

    /**
     * @param Validator_09 Validator
     */
    private $validator9;
    ...
    public function __construct(Bank $bank)
    {
        ...
        $this->validators[] = new Validator_20($bank);
        $this->validators[0]->setWeights(array(2, 3, 4, 5, 6, 7, 8, 9, 3));

        $this->validators[] = new Validator_29($bank);

        $this->validator9 = new Validator_09($bank);
