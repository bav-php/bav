 ...
 */
class Validator_51 extends Validator_Chain
{
    ...
    public static function getExceptionValidators(Bank $bank)
    {
        ...
        $exceptionValidators[] = new Validator_51x($bank);
        $exceptionValidators[] = new Validator_51x($bank);
